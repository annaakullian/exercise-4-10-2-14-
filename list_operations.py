...
def custom_append(input_list, value):
    ...
    new_list_length = custom_len(input_list) + 1
    input_list[0:new_list_length] = input_list + [value]
    return input_list

def custom_extend(input_list, values):
    """custom_extend(input_list, values) imitates input_list.extend(values)"""
    new_list_length = custom_len(input_list) + custom_len(values) + 1
    input_list[0:new_list_length] = input_list + (values)
    return input_list
...
def custom_insert(input_list, index, value):
    ...
    input_list[:length + 1] = input_list[:index] + [value] + input_list[index:]
...
def custom_index(input_list, value):
    ...
    for i in range(0, custom_len(input_list)):
        if value == input_list[i]:
            return i
    raise ValueError(value + ' is not the in the list')
...
def custom_equality(some_list, another_list):
    ...
    if list_length != custom_len(another_list):
        return False
